...
<section class="products">
  <div class="mb-5 flex justify-end">
    <a href="{{route('products.create')}}" class="btn btn-primary text-sm font-medium">Create New Product +</a>
  </div>
      ...
      <tbody class="divide-y divide-slate-300 dark:divide-slate-700">
        ...
        <tr>
          <form action="{{route('products.destroy', ['product' => $product])}}" method="post">
            ...
            @method('DELETE')
            <td class="p-4">
              <img src="{{asset($product->images[0]->name)}}" alt="{{$product->name}}" class="w-20 h-10 rounded">
            </td>
        ...
        @empty
        <tr>
          <td class="p-4" colspan="6">Not products created yet or not found! </td>
        </tr>
        @endforelse
      </tbody>
